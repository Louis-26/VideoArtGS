...
# work finished
- finish the pipeline procedure graph for both original VideoArtGS and refined version by Figma, with link: https://www.figma.com/design/7dDTR57ZKdyMfOiuJXp0s8/VideoArtGS-PAT-procedure-graph?node-id=2-5&t=svmJLwO8JqvSRpti-1
