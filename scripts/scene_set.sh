...
function parse_mode() {
    ...
    case "$current_mode" in
        ...
        3)
            ...
            ;;
        *)
            echo "❌ Error: Invalid input '$current_mode'. Please enter 1, 2, or 3."
            exit 1
            ;;
    esac
